...
func (m MovieModel) Insert(movie *Movie) error {
	...
	sqlQuery := `INSERT INTO movies(title,year,runtime,genres) 
				VALUES($1,$2,$3,$4)
...
func (m MovieModel) Get(id int64) (*Movie, error) {
	...
	sqlQuery := `SELECT id, created_at, title, year, runtime, genres, version
...
func ValidateMovie(v *validator.Validator, movie *Movie) {
	...
	v.Check(len(movie.Genres) > 0, "genres", "must contain atleast 1 genre")
